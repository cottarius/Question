...
VALUES
    ...
    ('Есть класс Point{int x, y;}. Почему хэш-код в виде 31 * x + y предпочтительнее чем x + y?', 'Уменьшает коллизии из-за перестановок', 'Это оптимизация для int', 'Для лучшей читаемости кода', 'Это требование JavaBeans'),
    ...
    ('Что такое ORM? Что такое JPA? Что такое Hibernate?', 'ORM — отображение объектов в БД, JPA — стандарт, Hibernate — реализация', 'ORM — СУБД, JPA — интерфейс, Hibernate — класс', 'ORM - реализация, JPA — отображение объектов в БД, Hibernate — стандарт', 'Hibernate — фреймворк для GUI'),
